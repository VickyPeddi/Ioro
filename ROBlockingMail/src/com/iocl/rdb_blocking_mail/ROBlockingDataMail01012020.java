...
/**
 *
 * @author t_sunita <mssunita23iocl@gmail.com>
 * Create Date : Dec 07, 2018
 */
public class ROBlockingDataMail01012020 {
...
//    String body = "";
    ...
    public static void main(String[] args) {
        ROBlockingDataMail01012020 obj = new ROBlockingDataMail01012020();
//    try {
//      // obj.maildealer();
//    } catch (Exception e) {
        ...
        try {
            ...
            try {
                ...
                String query = "SELECT * FROM (SELECT c.SALESORG_NAME ,\n"
                        ...
                        + " phase ) where message is not null and FO_EMAIL is not null";
