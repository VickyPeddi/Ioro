...
public class YV_IF_CUST_SALE_BLOCK {
    ...
    public String[] blockCheck(String[] roCodeArr, String[] roDivision, String soCode) {
        ...
        try {
            ...
            if (connection != null) {
                ret_msg = inv.get_message(sC, roCodeArr, roDivision, soCode);
                sC.disconnect();
            } else {
    ...
    public String[] get_message(sapConnect sC, String[] roCodeArr, String[] roDivision, String soCode) {
        String[] msg = null;
        ...
        try {
            ...
            if (function != null) {
                ...
                for (int i = 0; i < roCodeArr.length; i++) {
                    ...
                    inputValue.setValue(roDivision[i], "SPART");
